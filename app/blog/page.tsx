    ...
    <PageTransition>
      <section className="max-w-[1200px] mx-auto px-6 lg:px-10 pt-16 pb-8">
        ...
        >
          ...
          <p className="text-base md:text-lg text-text-secondary dark:text-text-secondary-dark max-w-2xl">
        ...
        >
          <div className="relative max-w-xl">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-xl border border-border dark:border-border-dark bg-card dark:bg-card-dark focus:ring-2 focus:ring-accent dark:focus:ring-accent-dark focus:outline-none transition-all text-sm text-text dark:text-text-dark placeholder:text-text-secondary dark:placeholder:text-text-secondary-dark shadow-sm"
            />
          </div>
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 py-2 rounded-full border text-xs font-semibold uppercase tracking-wider transition-all ${
                  cat === "All"
                    ? "bg-accent dark:bg-accent-dark text-white border-accent dark:border-accent-dark shadow-sm"
      ...
      <section className="max-w-[1200px] mx-auto px-6 lg:px-10 pb-16 md:pb-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-10 flex flex-col justify-end h-full">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight leading-[1.1]">
                Mastering C++ for Beginners
              </h2>
              <p className="text-sm text-white/90 mb-6 max-w-xl line-clamp-2 leading-relaxed">
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            {posts.slice(1, 3).map((post, i) => (
              <motion.article
                ...
                className="flex-1 rounded-2xl border border-border dark:border-border-dark bg-card dark:bg-card-dark p-6 group hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5"
              >
                <div className="mb-4">
                ...
                <p className="text-sm text-text-secondary dark:text-text-secondary-dark line-clamp-2 mb-4 leading-relaxed">
                  {post.excerpt}
                </p>
                <div className="flex items-center justify-between mt-auto pt-3 border-t border-border dark:border-border-dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          {posts.map((post, i) => (
            ...
            >
              <div className="h-40 bg-gradient-to-br from-accent/[0.06] via-accent/[0.03] to-accent-dark/[0.06] flex items-center justify-center relative">
              ...
              <div className="p-5">
                <h3 className="text-base font-semibold text-text dark:text-text-dark mb-2 group-hover:text-accent dark:group-hover:text-accent-dark transition-colors leading-snug">
                  {post.title}
                </h3>
                <p className="text-xs text-text-secondary dark:text-text-secondary-dark mb-3 leading-relaxed line-clamp-2">
                  {post.excerpt}
                </p>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-border dark:border-border-dark">
                  ...
                  <button className="px-4 py-1.5 rounded-lg bg-accent dark:bg-accent-dark text-white text-xs font-semibold hover:brightness-110 transition-all shadow-sm">
                    Enroll Now
                  </button>
                </div>
              </div>
