...
export default function Services() {
  return (
    <PageTransition>
      <section className="max-w-[1200px] mx-auto px-6 lg:px-10 pt-12 pb-8 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-base text-text-secondary dark:text-text-secondary-dark max-w-2xl leading-relaxed">
